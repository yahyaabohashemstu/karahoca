...
const STRINGS: Record<string, Record<string, string>> = {
  ar: {
    ...
    pageSubtitle: 'نصائح، أدلّة، وأفكار عملية حول التنظيف الاحترافي ومنتجات DİOX و AYLUX',
    ...
    seoDescription: 'مقالات حول طرق التنظيف الاحترافية، أدلّة استخدام منتجات DİOX و AYLUX، ونصائح لمالكي الفنادق والمنشآت التجارية.',
    seoKeywords: 'مدونة, تنظيف, نصائح, DİOX, AYLUX, قره خوجة, طرق استخدام',
  },
  en: {
    pageTitle: 'KARAHOCA Blog',
    pageSubtitle: 'Tips, guides, and practical ideas on professional cleaning with DİOX and AYLUX',
    allPosts: 'All posts',
    featured: 'Featured',
    latest: 'Latest',
    minRead: 'min read',
    ...
    seoDescription: 'Articles on professional cleaning methods, usage guides for DİOX and AYLUX products, and tips for hotels and businesses.',
    seoKeywords: 'blog, cleaning, tips, DİOX, AYLUX, KARAHOCA, how-to',
  },
  tr: {
    pageTitle: 'KARAHOCA Blog',
    pageSubtitle: 'DİOX ve AYLUX ile profesyonel temizlik üzerine ipuçları, rehberler ve pratik fikirler',
    ...
    seoDescription: 'Profesyonel temizlik yöntemleri, DİOX ve AYLUX ürün kullanım rehberleri ve oteller için ipuçları.',
    seoKeywords: 'blog, temizlik, ipuçları, DİOX, AYLUX, KARAHOCA, nasıl yapılır',
  },
  ru: {
    pageTitle: 'Блог KARAHOCA',
    pageSubtitle: 'Советы, руководства и практические идеи по профессиональной уборке с DİOX и AYLUX',
    allPosts: 'Все статьи',
    featured: 'Избранное',
    latest: 'Свежие',
    minRead: 'мин чтения',
    ...
    seoDescription: 'Статьи о профессиональных методах уборки, руководства по продуктам DİOX и AYLUX, советы для отелей и бизнеса.',
    seoKeywords: 'блог, уборка, советы, DİOX, AYLUX, KARAHOCA, как сделать',
  },
};
