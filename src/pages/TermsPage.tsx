...
const L: Record<string, { title: string; updated: string; sections: { heading: string; body: string }[] }> = {
  ar: {
    ...
    sections: [
      ...
      { heading: 'القانون الحاكم', body: 'تخضع هذه الشروط لقوانين الجمهورية التركية. أي نزاع ينشأ عن هذه الشروط يخضع للاختصاص القضائي الحصري لمحاكم غازي عنتاب، تركيا.' },
...
const TermsPage: React.FC = () => {
  ...
  return (
    <>
      ...
      <Header />
      <main id="main" style={{ minHeight: '60vh', padding: isMobile ? '2rem 1.25rem' : '4rem 2rem' }}>
