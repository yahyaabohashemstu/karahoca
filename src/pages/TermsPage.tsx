...
const L: Record<string, { title: string; updated: string; sections: { heading: string; body: string }[] }> = {
  ...
  tr: {
    ...
    sections: [
      ...
      { heading: 'Fikri Mülkiyet', body: 'Bu web sitesinde görüntülenen metin, görsel, logo ve ticari markalar (DIOX, AYLUX) dahil tüm içerikler KARAHOCA KIMYA\'nın mülkiyetindedir ve fikri mülkiyet yasaları ile korunmaktadır.' },
      ...
      { heading: 'Uygulanacak Hukuk', body: 'Bu şartlar Türkiye Cumhuriyeti yasalarına tabidir. Bu şartlardan doğan herhangi bir uyuşmazlık, Gaziantep, Türkiye mahkemelerinin münhasır yargı yetkisine tabidir.' },
