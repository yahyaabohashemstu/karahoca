...
export default function MobileFooter() {
  ...
  return (
    <footer id="contact" className="m-footer glass-panel" role="contentinfo">
      <div className="section-divider"></div>
      <div className="m-container footer__grid">
        ...
        <nav className="footer__links" aria-label={t('footer.links.title')}>
          ...
          {isHomePage ? (
            ...
            <Link to={aboutHref} className="footer-link">{t('footer.links.about')}</Link>
          )}
          {isHomePage ? (
            <a href={numbersHref} className="footer-link">{t('footer.links.numbers')}</a>
          ) : (
            <Link to="/#numbers" className="footer-link">{t('footer.links.numbers')}</Link>
          )}
        </nav>
